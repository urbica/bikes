const lang = {
  ...
  aboutDescription: {
    ru:
      'Urbica Design проанализировала статистику работы городского велопроката в 2015 году для Департамента транспорта Москвы. Данные о 812 000 поездок на 300 станциях проката были проанализированы и изучены по каждому направлению поездок в нескольких тематических срезах.',
    en:
      'Urbica Design analyzed the performance statistics of the city bicycle rental in 2015 for the Department of Magistral of Moscow. Data on 812 000 rides at 300 rental stations were studied and analyzed taking into account each ride direction and thematic segments. The detailed analysis identified main schemes of how bicycles were used in different districts of the city and explicitly showed the dependency of weather conditions on the use of a bicycle by various categories of riders.'
  },
  aboutModes: {
...
const menu = [
  ...
  { class: 'state', stateId: 'total', title: { ru: 'Общая статистика', en: 'Total stats' } },
  {
    class: 'state',
    stateId: 'in_out',
    title: { ru: 'Отправления/Прибытия', en: 'Departures/Arrivals' }
  },
  {
    class: 'state',
    stateId: 'roundtrips',
    title: { ru: 'Возврат на ту же станцию', en: 'Roundtrips' }
  },
  {
    class: 'state',
    stateId: 'unique',
    title: { ru: 'Уникальные пользователи', en: 'Unique users' }
  },
  { class: 'header', title: { ru: 'Районы', en: 'Districts' } },
  {
    class: 'state',
    stateId: 'districts_local',
    title: { ru: 'Поездки внутри района', en: 'Local rides' }
  },
  {
    class: 'state',
    stateId: 'districts_traffic',
    title: { ru: 'Трафик между районами', en: 'Traffic between districts' }
  },
...
const keynote = [
  //  37.609367701865324,"lat":55.76494759216348
  {
    stateId: 'total',
    description: {
      ru: 'Общее число поездок с каждой станции в период с 1 мая по 30 сентября',
  ...
  },
  {
    ...
    description: {
      ru:
        'Cоотношение числа прибытий и отправлений с каждой конкретной станции. Если число больше 100% – это означает, что с этого места чаще уезжали, чем оставляли там велосипеды',
      en:
        'The ratio of arrivals and departures from each specific station. If the number is more than 100%, it means that the place has been left more frequently than arrived at'
    },
    flyTo: {
      zoom: 14,
      speed: 0.1
  ...
  },
  {
    ...
    description: {
      ...
      en:
        'The leading station by the number of arrivals in reference to departures is the station at the Lomonosov avenue'
    },
    flyTo: {
  ...
  },
  {
    stateId: 'in_out',
    description: {
      ru: 'А по числу отправлений — станция перед входом в Парк Горького',
      en:
        'As for the number of departures, the leader is the station at the entrance of the Gorky Park'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Процент поездок, закончившихся на этой станции. Как правило это поездки с целью прогулок.',
      en:
        'The percentage of rides with the last stop at this station. As a rule, these rides are taken for outing'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'По числу поездок с возвратом на ту же станцию лидируют станции проката, в дальних районах рядом с парками. Например, рядом Битцевским парком',
      en:
        'The leading stations by the number of rides with a return to the same station are the stations in far districts near the parks, for example, near the Bitsevsky Park'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Процент новых пользователей на каждой станции. Чем больше новых пользователей, тем эта станция более «туристическая». Чем меньше это значение — тем больше регулярных велосипедистов на этой станции',
      en:
        'The percentage of new riders at each station. The more new riders there are, the more “touristic” the station is. The lower the number is, the more regular riders there are at this station'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Хамовники — один из районов-лидеров по числу поездок внутри района. Территория Хамовников ограничена набережной Москвы-реки с трёх сторон',
      en:
        'Khamovniki is one of the leading districts by the number of rides within the district. The area of Hamovniki is bounded from the three sides by the Moskva River embankment'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Распределение маршрутов велопроката по тарифам. Карта иллюстрирует по каким маршрутам больше всего катаются пользователи с тем или иным тарифом.',
      en:
        'Distribution of routes by the fare type. The map shows the routes that passed by the largest number of riders with a certain fare — «Day», «Month» or «Season» '
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Самый активный пользователь, сделал 1114 поездок с суммарным временем поездок 17 162 минуты (это почти 12 суток).',
      en:
        'Most active rider made 1114 rides with the total ride time is 17 162 minutes (it is about 12 days)'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Самый активный пользователь, сделал 1114 поездок с суммарным временем поездок 17 162 минуты (это почти 12 суток)',
      en:
        'The most popular bicycle is the number 2222. It has driven for 11 days – during this time 2222 could get to China from Moscow'
    },
    flyTo: {
  ...
  },
  {
    ...
    description: {
      ru:
        'Это аппарат под номером 2222. Суммарно за сезон он проехал 11 дней – за это время 2222 мог бы доехать из Москвы до Китая.',
      en:
        'The most popular bicycle is the number 2222. It has driven for 11 days – during this time 2222 could get to China from Moscow'
    },
    flyTo: {
...
const states = [
  {
    ...
    label: {
      en: 'Total stats on each station',
  ...
  },
  {
    ...
    legend: {
      description: {
        en: 'Total stats',
        ru:
          'Соотношение общего числа исходящих поездок (отправления) к входящим. Чем больше это соотношение — тем более односторняя станция.'
      },
  ...
  },
  {
    ...
    legend: {
      description: {
        en: 'Total stats',
        ru: 'Процент поездок, которые закончились на той же станции, откуда был взят велосипед.'
      },
  ...
  },
  {
    ...
    legend: {
      description: {
        en: 'Total stats',
        ru: 'Доля поездок с возвратом велосипеда на станцию в этом же районе.'
      },
  ...
  },
  {
    ...
    legend: {
      description: {
        en: 'Total stats',
        ru: 'Маршруты у которых доля всех поездок больше половины, по тарифам.'
      },
      image: 'legend-fares.svg',
      min: { en: 'daily fare', ru: 'дневной' },
      max: { en: 'season fare', ru: 'сезонный' },
      disclaimer: {
        en: 'Routes built automaticaly',
        ru:
          'Так как GPS-данных у Велобайка нет, линии маршрутов построены автоматически и представляют собой некоторое усреднение.'
      }
    },
    layers: [
      {
  ...
  },
  {
    ...
    legend: {
      description: {
        en: 'Total stats',
        ru: 'Пользователь, который сделал 3106 поездки за весь сезон.'
      },
  ...
  },
  {
    ...
    legend: {
      description: {
        en: 'Total stats',
        ru: 'Велосипед — лидер по числу поездок. Его брали в прокат 558 раз за сезон.'
      },
